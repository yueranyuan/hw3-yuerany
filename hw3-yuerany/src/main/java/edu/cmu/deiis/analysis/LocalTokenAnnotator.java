 ...
 *
 */
public class LocalTokenAnnotator extends JCasAnnotator_ImplBase {
  
  private LocalTestElementTokenizeProcessor tokenizeProcessor = 
          new LocalTestElementTokenizeProcessor();
